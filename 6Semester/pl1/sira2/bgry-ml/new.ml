...
let rec mover1  (a2::a1::a5::a0::a4::a3::a6::a7::a8::a9::a10::a11::c)= (a0::a1::a2::a3::a4::a5::a6::a7::a8::a9::a10::a11::c);;
let rec mover2  (a0::a3::a2::a6::a1::a5::a4::a7::a8::a9::a10::a11::c)=(a0::a1::a2::a3::a4::a5::a6::a7::a8::a9::a10::a11::c) ;;
let rec mover3  (a0::a1::a2::a3::a4::a7::a6::a10::a5::a9::a8::a11::c)=(a0::a1::a2::a3::a4::a5::a6::a7::a8::a9::a10::a11::c) ;;
let rec mover4  (a0::a1::a2::a3::a4::a5::a8::a7::a11::a6::a10::a9::c)=(a0::a1::a2::a3::a4::a5::a6::a7::a8::a9::a10::a11::c) ;;
...
let  moves v t= match t with
| 0-> let k = hashit v 0 in
         (((move1 v), hashit (move1 v) 0),(k,1)):: (((move2 v) ,hashit (move2 v) 0),(k,2))::(((move3 v),(hashit (move3 v) 0)) ,(k,3)) :: ((move4 v,hashit (move4 v) 0),(k,4))::[]
|1->  let k = hashit v 0 in
         (((mover1 v), hashit (mover1 v) 0),(k,1)):: (((mover2 v) ,hashit (mover2 v) 0),(k,2))::(((mover3 v),(hashit (mover3 v) 0)) ,(k,3)) :: ((mover4 v,hashit (mover4 v) 0),(k,4))::[];;
...
let rec  bfs q1 q2 hash1 hash2 n= 
        let a =  Queue.pop q1  in
        if Hashtbl.mem hash2 (hashit a 0) then (hashit a 0)
        else
                let b = List.filter (fun x-> not (Hashtbl.mem hash1 (gethash x))) (moves a n) in
                let _ =List.iter (fun x-> Hashtbl.add hash1 (gethash x) (second x)) b in
                let _ = push b q1 in
                bfs q2 q1 hash2 hash1 ((n+1) mod 2)  
;;
...
let rec solve s q1 q2= 
        ...
        let k=   bfs q1 q2 hash1 hash2 0 in
        let alist = res1 k hash1 [] and
        blist = res1 k hash2 []
        in
       ( alist @ blist) ;;
let main = 
